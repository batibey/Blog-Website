    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block">
                <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="Dosyalar/img/me6.jpg" alt="">
            </span>
        </a>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <div class="my-auto">
                    ...
                    <div class="subheading mb-5">
                        ...
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("TELEFON") %>'></asp:Label><p>
                                                                                                        </p>
                    ...
                    <div class="social-icons">
                        <a href="https://www.linkedin.com/in/mustafa-bat%C4%B1-738a00188/">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a href="https://github.com/batibey">
                            <i class="fab fa-github"></i>
                        </a>

                        <a href="https://www.instagram.com/mustafabati_/">
